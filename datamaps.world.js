(function() {
  ...
  */
    function val(datumValue, optionsValue, context) {
        ...
        var value =
            typeof datumValue !== 'undefined' ? datumValue : optionsValue;
        ...
        geo.enter()
            ...
            .style('fill', function(d) {
                ...
                if (typeof fillColor === 'undefined') {
                    fillColor = val(
                        datum && datum.fillColor,
                        fillData.defaultFill,
        ...
        if (options.highlightOnHover || options.popupOnHover) {
            svg.selectAll('.datamaps-subunit')
                    ...
                    if (options.highlightOnHover) {
                        ...
                        $this
                            .style(
                                'fill',
                                val(
                                    datum.highlightFillColor,
                                    options.highlightFillColor,
                                    datum
                                )
                            )
                            .style(
                ...
                .on('mouseout', function() {
                    ...
                    d3.selectAll('.datamaps-hoverover').style(
                        'display',
                        'none'
                    );
                });
            ...
            .attr('d', function(datum) {
                ...
                if (options.greatArc) {
                    ...
                    var greatArc = d3.geo
                        ...
                        .source(function(d) {
                            return [
                                val(d.origin.longitude, d),
                                val(d.origin.latitude, d)
                            ];
                        })
                        .target(function(d) {
                            return [
    ...
    function handleLabels(layer, options) {
        ...
        this.svg.selectAll('.datamaps-subunit').attr('data-foo', function(d) {
            ...
            layer
                ...
                .text(function() {
                    if (
                        options.customLabelText &&
                        options.customLabelText[d.id]
                    ) {
        ...
        bubbles
            ...
            .attr('r', function(datum) {
                ...
                return options.animate
                    ? 0
                    : val(datum.radius, options.radius, datum);
            })
            .attr('data-info', function(datum) {
                return JSON.stringify(datum);
            })
            ...
            .style('fill', function(datum) {
                var fillColor =
                    fillData[val(datum.fillKey, options.fillKey, datum)];
  ...
  ***************************************/
    ...
    Datamap.prototype.draw = function() {
        ...
        if (options.geographyConfig.dataUrl) {
            ...
            draw(
                this[options.scope + 'Topo'] || options.geographyConfig.dataJson
            );
        }
            ...
            if (data.hasOwnProperty(subunit)) {
                ...
                if (subunitData === Object(subunitData)) {
                    ...
                    var geo = this.svg
                        ...
                        .attr(
                            'data-info',
                            JSON.stringify(this.options.data[subunit])
                        );
                }
